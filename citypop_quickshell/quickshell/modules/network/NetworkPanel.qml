...
Scope {
    ...
    Variants {
        ...
        DropdownPanel {
            ...
            stateOpen: NetworkManager.panelVisible
            stateScreen: NetworkManager.panelScreen
            onDismissed: NetworkManager.panelVisible = false

            cardWidth: 360
            cardHeight: Math.min(cardContentCol.implicitHeight + cardPadding * 2, 520)
            anchorMode: "widget"
            widgetCenterX: NetworkManager.panelX
            showNeonStrip: false
            ...
            ColumnLayout {
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        readonly property bool showPassword: passwordSsid === netItem.modelData.ssid
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                ...
                                if (netItem.isKnown) {
                                    ...
                                    passwordSsid = netItem.showPassword ? "" : netItem.modelData.ssid
                                }
                            }
                        }
                    }
