...
Scope {
    Variants {
        ...
        DropdownPanel {
            ...
            stateOpen: ClipboardState.visible
            stateScreen: ClipboardState.screen
            onDismissed: ClipboardState.visible = false

            cardWidth: 360
            cardHeight: ClipboardState.entryCount > 0 ? Math.min(480, (panel.screen ? panel.screen.height : 1080) * 0.7) : 150
            anchorMode: "widget"
            widgetCenterX: ClipboardState.panelX
            cardClip: true
            focusable: true
