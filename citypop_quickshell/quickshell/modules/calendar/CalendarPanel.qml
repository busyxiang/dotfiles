...
Scope {
    Variants {
        ...
        DropdownPanel {
            ...
            stateOpen: CalendarState.visible
            stateScreen: CalendarState.screen
            onDismissed: CalendarState.visible = false

            cardWidth: 320
            anchorMode: "widget"
            widgetCenterX: CalendarState.panelX
            ...
            Timer {
                id: copiedTimer
                interval: 1200
                onTriggered: panel.showCopied = false
            }
            ...
            ColumnLayout {
                                    ...
                                    MouseArea {
                                        ...
                                        onClicked: {
                                            if (dayCell.modelData.current) {
                                                panel.copyDate(dayCell.modelData.day)
                                                flashAnim.start()
                                            }
                                        }
                                    }
                ...
                Rectangle {
                    Layout.fillWidth: true
                    implicitHeight: panel.showCopied ? 24 : 0
                    color: Style.bgTertiary
                    radius: Style.radiusSm
                    clip: true
                    visible: panel.showCopied

                    Behavior on implicitHeight { NumberAnimation { duration: Style.animFast } }

                    StyledText {
                        anchors.centerIn: parent
                        text: "Copied: " + panel.copiedText
                        font.pixelSize: 11
                        color: Style.accentPink
                    }
                }
