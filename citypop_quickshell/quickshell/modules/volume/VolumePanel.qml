...
Scope {
    ...
    Variants {
        ...
        DropdownPanel {
            ...
            stateOpen: VolumeState.visible
            stateScreen: VolumeState.screen
            onDismissed: VolumeState.visible = false

            cardWidth: 340
            cardHeight: Math.min(cardContent.implicitHeight + cardPadding * 2, (panel.screen ? panel.screen.height : 1080) - Style.spaceXl * 2)
            anchorMode: "widget"
            widgetCenterX: VolumeState.panelX
            cardClip: true
