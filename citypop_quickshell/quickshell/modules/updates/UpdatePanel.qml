...
Scope {
    Variants {
        ...
        DropdownPanel {
            ...
            stateOpen: UpdateState.visible
            stateScreen: UpdateState.screen
            onDismissed: UpdateState.visible = false

            cardWidth: 380
            cardHeight: UpdateState.totalCount > 0 ? Math.min(500, (panel.screen ? panel.screen.height : 1080) * 0.7) : 150
            anchorMode: "top-left"
            cardClip: true
