...
Item {
    ...
    readonly property bool loading: WeatherState.current === null

    // Weather-aware icon color: purple for rain, amber for hot, pink default
    ...
    RowLayout {
        ...
        StyledText {
            text: WeatherState.current ? WeatherState.current.temp + "°" : "—"
